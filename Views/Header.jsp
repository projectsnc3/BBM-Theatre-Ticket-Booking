    ...
    <div class="nava fx" style="width: 100%">
        <nav class="navbar navbar-light ml">
			...
			%>
 					...
 					<li class="nav-item hover1     ">
                    <a class="nav-link text-white " href="Sepetim.jsp"><img src="../img/sepet.png" class="img1" alt=""><span class=" rounded-circle " style="padding:2px;background-color:#f50"><%=urunSayisi %></span><br> Biletlerim </a>
                </li>
        ...
        <div class="alert  bg-dark opak2 fx " style="width:100%;" role="alert">
            <ul class="mb-4 ul1">
                ...
                <div id="list-example">
                    <li class="li1"><a href="Home.jsp#list-item-1" class="aa ab" id="asd">Program</a></li>
                    <li class="li1"><a href="Home.jsp#list-item-2" class="aa ab">Turne</a></li>
                    <li class="li1"><a href="Home.jsp#list-item-3" class="aa ab">Festival</a></li>
                    <li class="li1"><a href="Home.jsp#list-item-4" class="aa ab">Duyurular</a></li>
                    <li class="li1"><a href="Home.jsp#list-item-5" class="aa ab">Destek</a></li>
                </div>

            </ul>
            <a href="Home.jsp"><img src="../img/theatre.jpg" class="img2 trans1" alt=""></a>
        </div>
